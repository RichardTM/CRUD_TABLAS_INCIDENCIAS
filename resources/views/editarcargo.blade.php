...
<legend>MODIFICAR EL CARGO</legend>
<hr class="linea">
<div class="form-group">

    <label for="">Edite el Cargo</label>
    <input value="{{$cargo->cargo}}" name="cargo" type="form-control" id="cargo" placeholder="Edite el Cargo">
